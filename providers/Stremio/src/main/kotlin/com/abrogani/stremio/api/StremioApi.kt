...
package com.abrogani.stremio.api

import androidx.compose.ui.util.fastDistinctBy
import androidx.compose.ui.util.fastFlatMap
import androidx.compose.ui.util.fastForEach
import com.abrogani.stremio.api.model.Addon
import com.abrogani.stremio.api.model.Catalog
import com.abrogani.stremio.api.model.EMBEDDED_IMDB_ID_KEY
import com.abrogani.stremio.api.model.EMBEDDED_STREAM_KEY
import com.abrogani.stremio.api.model.FetchCatalogResponse
import com.abrogani.stremio.api.model.FetchMetaResponse
import com.abrogani.stremio.api.model.StreamResponse
import com.abrogani.stremio.api.model.SubtitleResponse
import com.abrogani.stremio.api.model.toFilmMetadata
import com.abrogani.stremio.api.model.toFilmSearchItem
import com.abrogani.stremio.api.util.isValidUrl
import com.abrogani.stremio.settings.util.AddonUtil.DEFAULT_META_PROVIDER
import com.abrogani.stremio.settings.util.AddonUtil.DEFAULT_META_PROVIDER_BASE_URL
import com.abrogani.stremio.settings.util.AddonUtil.getAddons
...
internal class StremioApi(
    ...
    override suspend fun getMetadata(film: Film): FilmMetadata {
        ...
        if (addonSource == DEFAULT_META_PROVIDER) {
            return getMetadataFromDefaultMetaProvider(
                id = actualId,
                type = type,
                nameKey = nameKey
            )
    ...
    private suspend fun getMetadata(
        ...
        return response.film?.toFilmMetadata(addonName)
            ?: throw IllegalArgumentException("[$nameKey]> Meta data is null!")
    }

    private suspend fun FilmMetadata.getLinks(
        watchId: String,
        episode: Episode?,
        onLinkFound: (MediaLink) -> Unit
    ) {
        ...
        val isFromStremio = providerId.equals(STREMIO, true)
    ...
    private suspend fun getMetadataFromDefaultMetaProvider(
        id: String?,
        type: String,
        nameKey: String
    ): FilmMetadata {
